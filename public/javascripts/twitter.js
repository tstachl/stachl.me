...
function getTwitterFeed(user, count, replies) {
  ...
  $.getJSON('http://api.twitter.com/1/statuses/user_timeline/' + user + '.json?trim_user=true&count=' + (count + 20) + '&include_entities=1&exclude_replies=' + (replies ? '0' : '1') + '&callback=?', function(data) {
